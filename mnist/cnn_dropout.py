...
from jax.experimental.stax import Dense, Sigmoid, Relu, Tanh, LogSoftmax, Conv, MaxPool, Flatten, Dropout
...
if __name__ == "__main__":
    ...
    df0.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K0.csv", index_label=False)
    df1.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K1.csv", index_label=False)
    df2.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K2.csv", index_label=False)
    df3.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K3.csv", index_label=False)
    df4.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K4.csv", index_label=False)
    df5.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K5.csv", index_label=False)
    df6.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K6.csv", index_label=False)
    df7.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K7.csv", index_label=False)
    df8.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K8.csv", index_label=False)
    df9.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_K9.csv", index_label=False)
    df10.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_train_loss.csv", index_label=False)
    df11.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_test_loss.csv", index_label=False)
    df12.to_csv("results/dropout/" + str(dropout_rate) + "/" + activator + "/cnn_test_class_loss.csv", index_label=False)
